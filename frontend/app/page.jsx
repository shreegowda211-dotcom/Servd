          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-xl md:text-2xl text-stone-600 mb-10 max-w-lg max-auto md:mx-0 font-light">
                  Snap a photo of your fridge. We&apos;ll tell you what to cook. Save money, reduce waste, and eat better tonight.
                </p>

                <Link href={'./dashboard'}>
                  <Button variant="primary" size="xl" className="px-8 py-6 text-lg">
              ...
              <Card className={"relative aspect-square md:aspect-4/5 border-4 border-stone-900 big-stone-200 overflow-hidden py-0"}>
                <Image
                  src="/pasta-dish.png"
                  ...
                  className="border-2 border-stone-200 bg-white hover:border-orange-600 hover:shadow-lg transition-all group py-0">
                    <CardContent className={"p-8"}>
                      <div className="flex justify-between items-start mb-6">
                        ...
                        <Badge variant="secondary" className={"text-xs font-mono bg-stone-100 text-stone-600 uppercase tracking-wide border border-stone-100"}>
                          {feature.limit}
                        </Badge>
